========================================================================
    APLICACIÓN DE CONSOLA: SmartProject_GrupoV Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SmartProject_GrupoV.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SmartProject_GrupoV.


SmartProject_GrupoV.vcxproj
...
SmartProject_GrupoV.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SmartProject_GrupoV.pch y un archivo de tipos precompilados llamado StdAfx.obj.
